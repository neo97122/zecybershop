<%@ Page Language="C#" AutoEventWireup="true" CodeFile="accessoires.aspx.cs" Inherits="tv" %>
...
<head runat="server">
    ...
    <body> 
       ...
       <div id="corps" >
        <div id="intro">
           <h1>Accessoires</h1>
           <h2>Vous pouvez triez par <a href="" ><strong>prix</strong></a>  par <a href="" ><strong>plateforme</strong></a> ou par <a href="" ><strong>marque</strong></a></h2> 
        </div>
